...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div id="templatmeo_container">
            ...
            <div id="templatemo_banner">
                ...
                <ul id="templatemo_left_menu_cust">
                    <li><a href="#"><span></span>Invoices</a></li>
                    <li><a href="{{ url('/site_detail') }}" class="current"><span></span>Sites</a></li>
                    <li><a href="{{ url('/cust_rmr') }}"><span></span>RMR</a></li>
                    <li><a href="{{ url('/workorder') }}"><span></span>WorkOrder</a></li>
   ...
   <table id="siteTable">
                <tr>
                    ...
                    <td>
                        <button class="button" id="myBtn"> <a href="{{ url('/site_add') }}">New Site</a></button>
                    </td>
                </tr>
            </table>
